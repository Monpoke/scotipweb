...
For our project, we have two kind of extensions:
\begin{itemize}
\item \textbf{"Binding keys"}
\item \textbf{Extension for a module}
\end{itemize}

The second type corresponds to the chosen module. For each one, two variables are defined in order to be reused later. The name of these extensions are called in this way: \textbf{SWITCHBOARD\_USER\_(CODE)}.
...
\section{Switchboard applications}
\subsection{Playback}
